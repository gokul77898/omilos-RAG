...
Orchestrator for the OmilosRAG pipeline:
...
class OmilosRAGService:
    """
    Full OmilosRAG pipeline orchestrator.
    ...
    def __init__(
        ...
        if settings.OMILOSRAG_ENABLE_KG:
    ...
    async def process_document(self, document_id: int, file_path: str) -> int:
        """
        Process a document through the full OmilosRAG pipeline.
        ...
        try:
            ...
            logger.info(
                f"OmilosRAG processed document {document_id}: "
            ...
            logger.error(f"OmilosRAG failed for document {document_id}: {e}")
    ...
    async def delete_document(self, document_id: int) -> None:
        ...
        logger.info(f"Deleted document {document_id} from OmilosRAG stores")
