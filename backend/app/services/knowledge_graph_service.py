...
class KnowledgeGraphService:
    ...
    def __init__(
        ...
        self.kg_language = kg_language or settings.OMILOSRAG_KG_LANGUAGE
        self.kg_entity_types = kg_entity_types or settings.OMILOSRAG_KG_ENTITY_TYPES
        self._rag = None
    ...
    async def _get_rag(self):
        ...
        self._rag = LightRAG(
            ...
            chunk_token_size=settings.OMILOSRAG_KG_CHUNK_TOKEN_SIZE,
            enable_llm_cache=True,
            kv_storage="JsonKVStorage",
            vector_storage="NanoVectorDBStorage",
            graph_storage=settings.OMILOSRAG_KG_GRAPH_STORAGE,
    ...
    async def query(
        ...
        try:
            ...
            logger.warning(
                f"KG query timed out after {settings.OMILOSRAG_KG_QUERY_TIMEOUT}s "
