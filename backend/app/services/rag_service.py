...
) -> "RAGService | OmilosRAGService":
    """Factory function: routes to OmilosRAGService or legacy RAGService based on config."""
    from app.core.config import settings

    if settings.OMILOSRAG_ENABLED:
        from app.services.nexus_rag_service import OmilosRAGService
        return OmilosRAGService(
            db=db,
